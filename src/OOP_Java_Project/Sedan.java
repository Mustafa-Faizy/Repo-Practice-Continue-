...
public class Sedan extends Car {
	...
	public Sedan (String name, String model, int maxspeed, String owner, double mpg, 
			int currentSpeed, boolean engineStatus) {
		super(name, model, maxspeed, owner, mpg, currentSpeed, engineStatus);
	}

	public Sedan (String name, String make, String model, int maxSpeed, int year, String owner, 
	...
	public String toString () {
		return "Sedan data [Sedan Name: " + super.getName()+ " "+ "Make"+ super.getMake()+ " " + "Model" + 
