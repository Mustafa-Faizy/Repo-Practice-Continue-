...
public class Truck extends Car {
	...
	public Truck (String name, String model, int maxspeed, String owner, double mpg, 
			int currentSpeed, boolean engineStatus) {
		super(name, model, maxspeed, owner, mpg, currentSpeed, engineStatus);
	}

	public Truck (String name, String make, String model, int maxSpeed, int year, String owner, 
	...
	public String toString () {
		return "Truck data [Truck Name: " + super.getName()+ " "+ "Make"+ super.getMake()+ " " + "Model" + 
